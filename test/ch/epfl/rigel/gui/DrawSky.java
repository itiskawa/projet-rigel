        ...
        try (InputStream hs = resourceStream("/hygdata_v3.csv")){
            try (InputStream asterStream = getClass()
                    ...
                    HorizontalCoordinates projCenter =
                            ...
                            //HorizontalCoordinates.ofDeg(45, 0);
                            //HorizontalCoordinates.ofDeg(0, 90); // center right above yr head
                            //HorizontalCoordinates.ofDeg(3.7, -65); // supposedly centred on moon
                            //HorizontalCoordinates.ofDeg(0, 23);
                            HorizontalCoordinates.ofDeg(277, -23); // supposedly centred on sun
                            //HorizontalCoordinates.ofDeg(265, -23);
                            //HorizontalCoordinates.ofDeg(30, -30);
